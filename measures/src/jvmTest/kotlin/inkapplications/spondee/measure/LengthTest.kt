...
class LengthTest {
    ...
    fun conversions() {
        12.hundredthsOfInches.run {
            ...
            assertEquals(0.000001893939, inMiles, .000000000001)
        ...
        12.inches.run {
            ...
            assertEquals(0.0001893939, inMiles, .0000000001)
        ...
        12.feet.run {
            ...
            assertEquals(0.002272727, inMiles, .000000001)
        ...
        12.millimeters.run {
            assertEquals(47.24409, inHundredthsOfInches, 0.00001)
            assertEquals(0.4724409, inInches, 0.0000001)
            assertEquals(0.03937007513, inFeet, 0.00000001)
            assertEquals(0.000007456454, inMiles, .000000000001)
        ...
        12.centimeters.run {
            assertEquals(472.4409, inHundredthsOfInches, 0.0001)
            assertEquals(4.724409, inInches, 0.000001)
            assertEquals(0.3937008, inFeet, 0.00000001)
            assertEquals(0.00007456454, inMiles, .00000000001)
        ...
        12.meters.run {
            assertEquals(47244.09, inHundredthsOfInches, 0.01)
            assertEquals(472.4409, inInches, 0.0001)
            assertEquals(39.37008, inFeet, 0.000001)
            assertEquals(0.007456454, inMiles, 0.000000001)

            assertEquals(12000.0, inMillimeters, 0.1)
            assertEquals(1200.0, inCentimeters, 0.1)
            assertEquals(12.0, inMeters, 0.1)
            assertEquals(0.012, inKilometers, 0.0001)
        }

        12.kilometers.run {
            assertEquals(47244090.0, inHundredthsOfInches, 10.0)
            assertEquals(472440.9, inInches, 0.1)
            assertEquals(39370.08, inFeet, 0.01)
            assertEquals(7.456454, inMiles, 0.000001)
